                                ...
                                @forelse ($data as $dokumen)
                                    <tr class="py-5">
                                        ...
                                        <td class="px-6 py-4 text-right">
                                            <a href="/format/{{$dokumen->format_id}}/cetak-dokumen/{{$dokumen->id}}"
                                                target="_blank" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Cetak Dokumen</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
